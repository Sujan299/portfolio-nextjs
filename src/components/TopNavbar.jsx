...
export default function TopNavbar() {
    ...
    return (
        <div className='w-100 bg-custom-dark'>
            <nav className='sm:h-16 h-16 flex justify-end md:justify-between items-center'>
                {clickMe && <nav className='w-[100vw] h-[100vh] .nav fixed top-0 left-0 bg-custom-darkOne z-10 flex flex-col pl-16 pr-16 pt-14 md:hidden gap-y-6'>
                ...
                <h1 className='mr-4 md:mr-14'><button className='px-3 py-2 bg-green-500 rounded-sm text-white text-opacity-100'>contact me!</button></h1>
